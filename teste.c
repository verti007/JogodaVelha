...
void example() {
    ...
    printf(TAB_VER " 1 " TAB_VER " A " TAB_VER " B " TAB_VER " C " TAB_VER "\n");
    printf(TAB_ML TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MR "\n");
    printf(TAB_VER " 2 " TAB_VER " D " TAB_VER " E " TAB_VER " F " TAB_VER "\n");
    printf(TAB_ML TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MJ TAB_HOR TAB_HOR TAB_HOR TAB_MR "\n");
    printf(TAB_VER " 3 " TAB_VER " G " TAB_VER " H " TAB_VER " I " TAB_VER "\n");
